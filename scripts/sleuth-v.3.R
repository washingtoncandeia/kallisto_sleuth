...
write.table(as.data.frame(head(sleuth_significant, 400)), sep = "\t", "significant_wt_3.txt", row.names = F)
##----------------------------------------------------------------
...
write.table(as.data.frame(t2g), sep = ",", "sleuth_zika_Gene-names_WT.txt", row.names = F)
