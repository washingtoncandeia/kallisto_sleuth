...
pop <- c(rep(GBS, 3),      # GBS        1
         rep(CONTROL, 3),  # Control   10
         rep(CONTROL, 3),  # Control   11
         rep(ZIKA, 3),     # Zika      12
         rep(GBS, 3),      # GBS       13
         rep(GBS, 3),      # GBS       14
         rep(GBS_REC, 3),  # GBSrec    16 
         rep(CHIKV_REC, 3),# Chikv rec 18
         rep(CONTROL, 3),  # Control   19
         rep(GBS, 3),      # GBS        2
         rep(CONTROL, 3),  # Control   20
         rep(CHIKV, 3),    # Chikv     22
         rep(ZIKA, 3),     # Zika      24
         rep(GBS, 3),      # GBS       25
         rep(GBS_REC, 3),  # GBSrec    27
         rep(GBS_REC, 3),  # GBSrec    28
         rep(GBS_REC, 3),  # GBSrec    30
         rep(CHIKV, 3),    # Chikv     31
         rep(CHIKV, 3),    # Chikv     32
         rep(CONTROL, 3),  # Control   33  
         rep(CONTROL, 3),  # Control   34
         rep(CHIKV_REC, 3),# Chikv rec 35
         rep(ZIKA, 3),     # Zika      36
         rep(GBS_REC, 3),  # GBSrec    38
         rep(GBS_REC, 3),  # GBSrec    39
         rep(GBS, 3),      # GBS        4
         rep(CHIKV, 3),    # Chikv     40
         rep(CHIKV_REC, 3),# Chikv rec 41
         rep(CHIKV_REC, 3),# Chikv rec 42
         rep(CHIKV_REC, 3),# Chikv rec 46
         rep(CHIKV_REC, 3),# Chikv rec 47
         rep(ZIKA, 3),     # Zika      48
         rep(GBS_REC, 3),  # GBSrec     7
         rep(GBS_REC, 3),  # GBSrec     8
         rep(GBS_REC, 3))  # GBSrec     9
...
# Pares
pares <- c(rep('não', 3),  # GBS        1
           rep('não', 3),  # Control   10
           rep('não', 3),  # Control   11
           rep('não', 3),  # Zika      12
           rep('não', 3),  # GBS       13
           rep('não', 3),  # GBS       14
           rep('par', 3),  # GBSrec    16 
           rep('não', 3),  # Chikv rec 18
           rep('não', 3),  # Control   19
           rep('não', 3),  # GBS        2
           rep('não', 3),  # Control   20
           rep('não', 3),  # Chikv     22
           rep('não', 3),  # Zika      24
           rep('não', 3),  # GBS       25
           rep('não', 3),  # GBSrec    27
           ...
           rep('não', 3),  # Chikv     31
           rep('não', 3),  # Chikv     32
           rep('não', 3),  # Control   33  
           rep('não', 3),  # Control   34
           rep('não', 3),  # Chikv rec 35
           rep('não', 3),  # Zika      36
           rep('não', 3),  # GBSrec    38
           rep('não', 3),  # GBSrec    39
           rep('não', 3),  # GBS        4
           rep('não', 3),  # Chikv     40
           rep('não', 3),  # Chikv rec 41
           rep('não', 3),  # Chikv rec 42
           rep('não', 3),  # Chikv rec 46
           rep('não', 3),  # Chikv rec 47
           rep('não', 3),  # Zika      48
           rep('par', 3),  # GBSrec     7
           rep('não', 3),  # GBSrec     8
           rep('par', 3))  # GBSrec     9
...
# Pares de condições
diagn <- c(rep('Desmielin', 3),   # GBS        1
           rep('não', 3),         # Control   10
           rep('não', 3),         # Control   11
           rep('não', 3),         # Zika      12
           rep('Desmielin', 3),   # GBS       13
           rep('Desmielin', 3),   # GBS       14
           rep('Desmielin', 3),   # GBSrec    16 
           rep('não', 3),         # Chikv rec 18
           rep('não', 3),         # Control   19
           rep('Desmielin', 3),   # GBS        2
           rep('não', 3),         # Control   20
           rep('não', 3),         # Chikv     22
           rep('não', 3),         # Zika      24
           rep('Desmielin', 3),   # GBS       25
           rep('Desmielin', 3),   # GBSrec    27
           rep('Desmielin', 3),   # GBSrec    28
           rep('Inconclus', 3),   # GBSrec    30
           rep('não', 3),         # Chikv     31
           rep('não', 3),         # Chikv     32
           rep('não', 3),         # Control   33  
           rep('não', 3),         # Control   34
           rep('não', 3),         # Chikv rec 35
           rep('não', 3),         # Zika      36
           rep('Desmielin', 3),   # GBSrec    38
           rep('Axonal', 3),      # GBSrec    39
           rep('Desmielin', 3),   # GBS        4
           rep('não', 3),         # Chikv     40
           rep('não', 3),         # Chikv rec 41
           rep('não', 3),         # Chikv rec 42
           rep('não', 3),         # Chikv rec 46
           rep('não', 3),         # Chikv rec 47
           rep('não', 3),         # Zika      48
           rep('Desmielin', 3),   # GBSrec     7
           rep('Desmielin', 3),   # GBSrec     8
           rep('Desmielin', 3))   # GBSrec     9


length(diagn)

# Sexo
sex <- c(rep('Fem', 3),  # GBS        1
         rep('Fem', 3),  # Control   10
         rep('Mas', 3),  # Control   11
         rep('Fem', 3),  # Zika      12
         rep('Mas', 3),  # GBS       13
         rep('Mas', 3),  # GBS       14
         rep('Mas', 3),  # GBSrec    16 
         rep('Fem', 3),  # Chikv rec 18
         rep('Mas', 3),  # Control   19
         rep('Fem', 3),  # GBS        2
         rep('Mas', 3),  # Control   20
         rep('Fem', 3),  # Chikv     22
         rep('Fem', 3),  # Zika      24
         rep('Fem', 3),  # GBS       25
         rep('Fem', 3),  # GBSrec    27
         ...
         rep('Mas', 3),  # Chikv     31
         rep('Fem', 3),  # Chikv     32
         rep('Fem', 3),  # Control   33  
         rep('Mas', 3),  # Control   34
         rep('Fem', 3),  # Chikv rec 35
         rep('Fem', 3),  # Zika      36
         rep('Mas', 3),  # GBSrec    38
         rep('Fem', 3),  # GBSrec    39
         rep('Fem', 3),  # GBS        4
         rep('Mas', 3),  # Chikv     40
         rep('Fem', 3),  # Chikv rec 41
         rep('Fem', 3),  # Chikv rec 42
         rep('Fem', 3),  # Chikv rec 46
         rep('Fem', 3),  # Chikv rec 47
         rep('Fem', 3),  # Zika      48
         rep('Fem', 3),  # GBSrec     7
         rep('Mas', 3),  # GBSrec     8
         rep('Fem', 3))  # GBSrec     9
...
write.table(samples_info, './tables/chikv/condition_chikv_vs_control.txt', sep = '\t')
...
samples <- read.table('./tables/chikv/condition_chikv_vs_control.txt', header = TRUE, row.names = 1)
head(samples)
samples$condition 
mode(samples)
...
save(txi.kallisto, file = "./count_estimates/chikv/chikv.Rdata")
...
resChikrec <- results(dds, contrast=c('condition','chikv_rec','control'))
resChikrec <- as.data.frame(resChikrec)
resChikrec
write.csv(resChikrec, file = './GSEA/chikv/condition_chikv_rec_vs_control_alt_GSEA.csv')

# Alternativa 1: condition chikv vs control
resChikdis <- results(dds, contrast=c('condition','chikv','control'))
resChikdis

# Alternativa 2: condition chikv vs chikv_rec
resChikvChikv <- results(dds, contrast=c('condition','chikv','chikv_rec'))
resChikvChikv

# Criar csv para os contrastes acima (pode ser usado em fgsea)
write.csv(as.data.frame(res), file = './GSEA/chikv/condition_chikv_rec_vs_control_GSEA.csv')              # Coeficiente 3
write.csv(as.data.frame(resChikrec), file = './GSEA/chikv/condition_chikv_rec_vs_control_alt_GSEA.csv')   # Coeficiente 3
write.csv(as.data.frame(resChikdis), file = './GSEA/chikv/condition_chikv_doentes_vs_control_GSEA.csv')   # Coeficiente 2
...
# Criar csv (pode ser usado em fgsea)
write.csv(as.data.frame(resOrdered), file = './GSEA/chikv/condition_chikv_rec_vs_control_resOrdered_GSEA.csv')

# res05 padj < 0.05
write.csv(as.data.frame(res05), file = './GSEA/chikv/condition_chikv_rec_vs_control_res05padj_GSEA.csv')
### Lembrar dos objetos:
# res
# res05 (padj < 0.05)
# resOrdered
