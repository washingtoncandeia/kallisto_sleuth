...
# Script lrt
# Supercomputador - Likelihood Ratio Test lrt
##--------------------------------------------
...
write.table(as.data.frame(head(sleuth_significant, 100)), sep = "\t", "significant_1.txt", row.names = F)
...
write.table(as.data.frame(t2g), sep = ",", "sleuth__Gene-names_lrt.txt", row.names = F)
